...
export class CreateComponent implements OnInit {
  ...
  constructor(
    ...
    private mqttService: MqttService // MQTT-Service hinzufügen
  ) { }
  ...
  sendMqttMessage(): void {
    const topic = '/Moba/ESPNetzwerk'; // Ersetzen Sie dies durch Ihr gewünschtes Topic
    const message = 'Hp0'; // Ersetzen Sie dies durch Ihre Nachricht
